package com.example.ibip.PrimerTrimestre.dialogos;
...
public class DialogoActivity extends AppCompatActivity implements YesNoDialogFragment.YesNoDialogFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialogs_fragment_activity);
