package com.example.ibip.PrimerTrimestre.calculadorapasarDatosActivityResultadoAtras;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void enviarTextoAOtraActivity(View view){
        Intent i = new Intent(this, com.example.ibip.PrimerTrimestre.calculadorapasarDatosActivityResultadoAtras.MainActivity2.class);
