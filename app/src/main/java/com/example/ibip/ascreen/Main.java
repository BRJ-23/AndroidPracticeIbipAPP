...
public class Main extends AppCompatActivity {
    ...
    public void listviewpepe(View view){
        Intent i = new Intent(this, com.example.ibip.listViewPepe.MainActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }
    ...
    public void listviewguide(View view){
        Intent i = new Intent(this, com.example.ibip.Utilities___X.adapter.MainActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }

    public void spinnerpaisito(View view){
        Intent i = new Intent(this, com.example.ibip.spinnerPaisBandera.MainActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }

    public void menuoverflow(View view){
        Intent i = new Intent(this, com.example.ibip.menuOverflow.MainActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }
